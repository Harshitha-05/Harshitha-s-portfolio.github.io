(function () {
  ...
  window.addEventListener('load', () => {
    ...
    if (achievementsContainer) {
      ...
      on('click', '#achievements-flters li', function (e) {
        e.preventDefault();
  ...
  /**
   * Initiate achievements lightbox 
   */
  const achievementsLightbox = GLightbox({
    selector: '.achievements-lightbox'
  });

  /**
   * achievements details slider
   */
  new Swiper('.achievements-details-slider', {
    speed: 400,
    loop: true,
    autoplay: {
      delay: 5000,
